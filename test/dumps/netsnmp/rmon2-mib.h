 ...
 *
 * $Id: rmon2-mib.h 1154 2001-08-24 10:09:18Z strauss $
 */
...
typedef struct protocolDirEntry {
    ...
    u_char    __protocolDirID[65535];
    u_char    __protocolDirParameters[65535];
...
typedef struct addressMapEntry {
    ...
    u_char    __addressMapNetworkAddress[65535];
...
typedef struct nlMatrixSDEntry {
    ...
    u_char    __nlMatrixSDSourceAddress[65535];
    u_char    __nlMatrixSDDestAddress[65535];
...
typedef struct nlMatrixDSEntry {
    ...
    u_char    __nlMatrixDSSourceAddress[65535];
    u_char    __nlMatrixDSDestAddress[65535];
...
typedef struct nlMatrixTopNEntry {
    ...
    u_char    __nlMatrixTopNSourceAddress[65535];
    u_char    __nlMatrixTopNDestAddress[65535];
...
typedef struct alMatrixTopNEntry {
    ...
    u_char    __alMatrixTopNSourceAddress[65535];
    u_char    __alMatrixTopNDestAddress[65535];
